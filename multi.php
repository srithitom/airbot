...
<body>
    ...
    <p><?php
        ...
        if($score > 100){
            ...
            echo "คะแนนต่ำกว่า 0 กรุณากรอกคะแนนอีกครั้ง";
        }
    ?></p><br>
    <table>
        <tr>
            <th>ระดับคะแนน (เกรด)</th><th>คะแนน</th>
        </tr>
        <tr class="bggreen">
            <th>A</th><td>80 คะแนนขึ้นไป</td>
        </tr>
        <tr class="bggreen">
            <th>B+</th><td>75 – 79 คะแนน</td>
        </tr>
        <tr class="bggreen">
            <th>B</th><td>70 – 74 คะแนน</td>
        </tr>
        <tr class="bgyellow">
            <th>C+</th><td>65 – 69 คะแนน</td>
        </tr>
        <tr class="bgyellow">
            <th>C</th><td>60 – 64 คะแนน</td>
        </tr>
        <tr class="bgyellow">
            <th>D</th><td>55 – 59 คะแนน</td>
        </tr>
        <tr class="bgyellow">
            <th>C+</th><td>50 – 54 คะแนน</td>
        </tr>
        <tr class="bgred">
            <th>C+</th><td>0 – 49 คะแนน</td>
        </tr>
    </table>
    </center>
</body>
